...
cd /d %KEYCLOAK_HOME%
bin\kc.bat start-dev --import-realm --http-enabled=true --http-port=8093 --https-port=8456 --https-key-store-file=localhost.p12 --https-key-store-password=12345678
