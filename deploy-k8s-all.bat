...
if "%1" == "eks" (
    echo Not implemented yet. Run individual deploy scripts.
    goto :EOF
)
if "%1" == "aks" (
    echo Not implemented yet. Run individual deploy scripts.
...
call mvn -f microcoffeeoncloud-database\pom.xml gplus:execute -Ddbhost=%EXTERNAL_IP% -Ddbport=%DB_PORT% -Ddbname=microcoffee -Dshopfile=microcoffeeoncloud-database\oslo-coffee-shops.xml
